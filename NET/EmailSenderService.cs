public class EmailSenderService : IEmailSenderService
{
    ...
    public void SendChangePasswordEmail(SendEmailRequest model, string token)
    {
        ...
        //string adminMessageTemplate = $"<html><body><h1>Thank you for choosing Fairly! Please reset your password.</h1> <h5> <a href={emailHref+"?token="+token+"&email="+model.To.Email}> Reset Fairly password here</a><h5/> </p></body></html>";
